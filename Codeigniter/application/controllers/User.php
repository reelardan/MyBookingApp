...
class User extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('viewsnya' , $data);//membuka form index dan memasukkan variabel data
	}

	// Add a new item
	public function add()
	{
		$this->load->view('booking');//memanggil form untuk input data yg berada di folder user
	}
	...
	{  
		$this->db->where('user_id',$id);//memasukkan id yg sudah dipilih dan menentukan id mana yg akan dihapus
